...
//        JOptionPane.showMessageDialog(this, "\"Home\" Is Pressed");
            if (!(currentFrame instanceof home_dsb)) { // Check if current frame is not already home_dsb
                closeCurrentFrame(); // Close current frame if any
                home_dsb home = new home_dsb(); // Create a new home_dsb frame
                home.setVisible(true); // Set the new frame to visible
                currentFrame = home; // Set currentFrame to the new frame
            }
...
//        JOptionPane.showMessageDialog(this, "\"RFQ\" Is Pressed");
            closeCurrentFrame();
            RFQ_dsb rfq_dsb = new RFQ_dsb();
            rfq_dsb.setVisible(true);
            currentFrame = rfq_dsb;
    ...
    private void BiddingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BiddingActionPerformed
            closeCurrentFrame();
            JOptionPane.showMessageDialog(this, "\"Bidding\" Is Pressed");
